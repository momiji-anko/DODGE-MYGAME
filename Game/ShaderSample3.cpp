...
const std::vector<D3D11_INPUT_ELEMENT_DESC> ShaderSample3::INPUT_LAYOUT =
{
...
//	RE	:	void
//-----------------------------------------------------------------------------------
void ShaderSample3::SetRenderState(DirectX::SimpleMath::Vector3 camera, DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj)
{
	m_camera = camera;
	m_view = view;
	m_proj = proj;
...
void ShaderSample3::Initialize(float life, Vector3 pos, Vector3 velocity)
{
	m_startPosition = pos;
...
//	RE	:	void
//-----------------------------------------------------------------------------------
void ShaderSample3::Update(StepTimer timer)
{
...
void ShaderSample3::Draw()
{
}

void ShaderSample3::Lost()
{
	m_CBuffer.Reset();
	m_inputLayout.Reset();
	m_batch.reset();
...
void ShaderSample3::SetGravity(bool gravity)
{
	m_isGravity = gravity;
